...
a = databaseLoad.Load()
#a.run("insert into l_user(name,password,permission) value ('gaomei',password('gaomei'),0),('test1',password('gaomei'),1),('test2',password('gaomei'),2),('test3',password('gaomei'),0);")
